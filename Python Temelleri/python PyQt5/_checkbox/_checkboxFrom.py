...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lblResult.setGeometry(QtCore.QRect(330, 80, 91, 81))
        self.lblResult.setObjectName("lblResult")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(60, 60, 161, 121))
        ...
        self.cbKitapOkuma = QtWidgets.QCheckBox(self.widget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBox_2.setText(_translate("MainWindow", "Spor"))
